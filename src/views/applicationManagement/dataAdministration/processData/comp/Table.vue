<template>
  <div class="table">
    ...
    >
      ...
      <el-table-column show-overflow-tooltip prop="zname" label="组件名称">
      </el-table-column>
      <el-table-column show-overflow-tooltip prop="type" label="类型">
      </el-table-column>
      <el-table-column show-overflow-tooltip prop="rname" label="任务名称">
      </el-table-column>
      <el-table-column show-overflow-tooltip prop="rid" label="任务ID">
      </el-table-column>
      ...
      <el-table-column show-overflow-tooltip prop="status" label="状态">
        <template slot-show-overflow-tooltip scope="{ row }">
          <span
            :class="
              row.status == 1
                ? ''
