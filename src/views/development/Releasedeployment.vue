    ...
    <div class="deploymentCenter">
      <div style="height: 75px; line-height: 75px; padding-left: 100px">
        <span style="font-weight: bold; font-size: 18px"
          >正在处理【处理流程一】 发布 - 组件共 <span style="color: blue">10</span> 个</span
        >
        <span>（发布检查是否存在不匹配的部署设置）</span>
      </div>
  ...
  methods: {
    deployLogFunc() {
      ...
      window.setInterval(function () {
        ...
        that.useTime =
          (that.useTimeH < 10 ? "0" + that.useTimeH : that.useTimeH) +
          ":" +
