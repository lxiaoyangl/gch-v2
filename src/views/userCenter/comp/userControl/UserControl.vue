...
const fetchData = () => {
  // tableData = [];
  // let start = (nowPage.value - 1) * pageSize.value;
  // let end = nowPage.value * pageSize.value > tables.length ? tables.length : nowPage.value * pageSize.value;
  // for (let i = start; i < end; i++) {
  //   tableData.push(tables[i]);
  // }
  // total.value = tables.length;
  // currentPage.value = nowPage.value;
};
