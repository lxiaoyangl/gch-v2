<template>
  <div class="table">
    ...
    >
      ...
      <el-table-column show-overflow-tooltip prop="name" label="资源名称">
      </el-table-column>
      <el-table-column
