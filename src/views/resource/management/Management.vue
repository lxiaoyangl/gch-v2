      ...
      <div class="box basic-information">
        ...
        <el-form size="medium" class="mtb10" label-width="100px" :model="basicInformation">
          ...
          <el-form-item label-width="65px">
            <el-button type="primary" @click="saveBasicInformation">确定</el-button>
          </el-form-item>
        </el-form>
      </div>
...
import { BasicInformation, GaugeChartData, TableData } from "../types";
import * as echarts from "echarts";
// 弹窗
let dialogVisible = false;
// 基本信息表单
let basicInformation: BasicInformation = reactive({
  name: "",
  type: "",
  status: 0,
  ip: "",
...
let tableHeader = [
  ...
  },
  {
    prop: "status",
    name: "当前状态",
    formatter: function (row: TableData) {
